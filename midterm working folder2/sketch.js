...
function setup(){
 ...
 s = new Star(1900/2,5700/2);
 s2 = new Star2(900/2,5700/2);
...
function draw(){
  ...
  noFill();
  stroke(102,186,183);
  startbt = rect(windowWidth/2,5700/2,400,100,20);
  rect(2000/2,6230/2,100,100,20);
  triangle(1990/2,6220/2,1990/2,6240/2,2020/2,6230/2)
  rect(1800/2,6230/2,100,100,20);
  triangle(1820/2,6220/2,1820/2,6240/2,1790/2,6230/2)
  stroke(240,160,107);
  rect(1000/2,6230/2,100,100,20);
  rect(800/2,6230/2,100,100,20);
  fill(240,160,107);
  ...
  text('START',1320/2,5730/2);
  if(mouseX > 1240/2 && mouseX < 1630/2 && mouseY > 734/2 && mouseY < 833/2){
    cursor('pointer')
    console.log('here');
    if(mouseIsPressed){
      start = true;
...
//resistance
  ...
  let planet1 = createVector(300/2,4000/2);
  ...
  let planet2 = createVector(800/2,4500/2);
  ...
  let planet3 = createVector(1500/2,4300/2);
  ...
  let planet4 = createVector(1300/2,5100/2);
  ...
  let planet5 = createVector(2300/2,4800/2);
  ...
  let planet6 = createVector(2450/2,4200/2);
  ...
  let planet7 = createVector(1900/2,3600/2);
  ...
  let planet8 = createVector(930/2,3400/2);
  ...
  let planet9 = createVector(2700/2,3000/2);
  ...
  let planet10 = createVector(200/2,2500/2);
...
if(s.reflection ){
  ...
  star1Reflections.push( new StarReflection(s.pos.x,canvasHeight-70/2,102,186,183));
}
...
if(s2.reflection ){
  star2Reflections.push( new StarReflection(s2.pos.x,canvasHeight-75/2,240,160,107));
}
