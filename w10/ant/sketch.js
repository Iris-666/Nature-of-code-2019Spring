...
class Vehicle{
  constructor(x, y){
    ...
    this.maxSteerForce = 0.05;//maxForce
  ...
  seek(target){
    ...
    steerForce = p5.Vector.sub(desiredVel, this.vel)
  ...
  display(){
    ...
    stroke(255);
    line(0, 0, steerForce.x*500, steerForce.y*500)
    stroke(0,255,0)
    line(0, 0, this.vel.x*500, this.vel.y*500)
    pop();
  }
}
